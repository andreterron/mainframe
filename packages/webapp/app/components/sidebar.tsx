...
export function Sidebar({ sidebarOpen }: SidebarProps) {
  ...
  //   <div
  //     className={cn(
  //       "h-screen shrink-0 grow-0 flex flex-col border-r items-stretch",
  //       className,
  //     )}
  //   >
  //     <div className="flex h-16 items-center px-4">
  //     </div>
  //     <div className="py-4 px-4 w-full flex-1 space-y-1">
  //       <Button
  //         asChild
  //         variant="ghost"
  //         className={cn(
  //           "w-full justify-start",
  //           rootMatch || newMatch ? "bg-gray-100" : "",
  //         )}
  //       >
  //         <Link to="/new-dataset">New</Link>
  //       </Button>
  //       {datasets.map((dataset) => (
  //         <Button
  //           key={dataset.id}
  ...
  //       ))}
  //       {/* <Search /> */}
  //       {/* TODO: Ensure this list is scrollable */}
  //       {/* <div className="py-2  w-full">
  //                   <div className="h-full w-full px-1 space-y-3">
  ...
  //     <div className="flex items-center px-4 space-x-4 mb-4">
  //       {/* <Search /> */}
  //       <UserNav />
  //     </div>
  //   </div>
